...
update subject set id = 1 where name='Введение в информационные технологии (Лаб.Занятие)';
update subject set id = 2 where name='Введение в информационные технологии (Практика)';
update subject set id = 3 where name='Математические основы баз данных (Лекция)';
update subject set id = 4 where name='Математические основы баз данных (Практика)';
update subject set id = 5 where name='Математические основы баз данных (Лаб.Занятие)';
update subject set id = 6 where name='Основы DevOps (Лекция)';
update subject set id = 7 where name='Основы DevOps (Практика)';
update subject set id = 8 where name='Основы DevOps (Лаб.Занятие)';
update subject set id = 9 where name='Выcшая математика (Лекция)';
update subject set id = 10 where name='Высшая математика (Практика)';
update subject set id = 11 where name='Физика (Лекция)';
update subject set id = 12 where name='Физика (Лаб.Занятие)';
update subject set id = 13 where name='Физика (Практика)';
update subject set id = 14 where name='Проектный практикум (Практика)';
update subject set id = 15 where name='История (Лекция)';
update subject set id = 16 where
